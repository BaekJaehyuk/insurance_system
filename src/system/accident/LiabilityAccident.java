...
public class LiabilityAccident extends Accident {
    ...
    public LiabilityAccident(long accidentId, String accidentDetails, String date, String location, long customerId, String medicalRecords, int victimInjuryDegree, String victimName, String victimPhoneNumber, String assessmentStatus) {
