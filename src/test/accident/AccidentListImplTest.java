...
class AccidentFactoryTest {
    ...
    @BeforeEach
    void setUp() {
        customer1 = new Customer("John Doe", "M", "010-1234-5678", "1980-01-01");
    ...
    void testPersonalInjuryAccidentWithDriverInsurance() {
        Accident accident = AccidentFactory.createAccident("PersonalInjury", 1, "Car accident", "2024-05-29", "Seoul", customer1, new String[]{"3", "2"});
    ...
    void testLiabilityAccidentWithAutoInsurance() {
        Accident accident = AccidentFactory.createAccident("Liability", 2, "House fire", "2024-06-01", "Busan", customer1, new String[]{"record1", "4", "Jane Doe", "010-8765-4321"});
        assertEquals("Pending", accident.getAssessmentStatus(), "Status should be Pending");
    ...
    void testPropertyDamageAccidentWithAutoInsurance() {
        Accident accident = AccidentFactory.createAccident("PropertyDamage", 3, "Tree fall on car", "2024-06-15", "Incheon", customer1, new String[]{"Car"});
        assertEquals("Pending", accident.getAssessmentStatus(), "Status should be Pending");
    ...
    void testPersonalInjuryAccidentWithoutDriverInsurance() {
        Customer customerWithoutDriverInsurance = new Customer("Jane Doe", "F", "010-8765-4321", "1990-01-01");
    ...
    void testLiabilityAccidentWithoutAutoInsurance() {
        Customer customerWithoutAutoInsurance = new Customer("Jane Doe", "F", "010-8765-4321", "1990-01-01");
